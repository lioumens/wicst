...
1. Minimum Viable (~10%)
   - We will identify /one/ customer, and create all three layers of the project to service the one customer. There will be strict boundaries on the data integrated
