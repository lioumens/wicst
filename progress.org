...
- pastures accounted for in pastures file
** REVIEW 2006
...
*** Missing Pasture Yields
Decision to delete nonharvests
**** 2008
- Plot 207: Janet Hedtcke: "southern 1/2 of plot flooded and reseeded in Aug"
* Tables
** tbl_2023_biomassing
...
- 3 (hay) harvests according to agcal calendar
  - only first 2 in arlington yields, but master has the third with the moistures.
  - imputed the lbs
- no biomassings
*** DONE 1991
...
*** REVISIT 2002
- [X] plot 302, unsure if there was actually a cut here, cs6_pasture sheet shows NA here
  - delete the 302 harvest moisture value
- agcal says only 3 harvests
- qa fails
*** 2003
...
*** REVISIT 2008
- [X] Missing cycle and tenday for calculations
  - hard code 2 for everything
- All the exclosures use the same 1.12 multiplier, except for
- 207 cut 2 does not use multiplier
- 302 cut 2 does not use multiplier
- YIELD
  - currently average of harvest without cycle goes into its own "NULL" category separate from 1-5
*** 2009
- harvests, exclosures, and biomassings
- have the 1.12 multiplier to get to the old arlington yields, but for master the yields are without the multiplier
- harvests are not in arl yields
*** REVISIT 2010
- I'm not sure what harvests here are real
- [X] the first hay exclosure yield looks like it's just copied from green chop, remove?
  - yes delete this oberservation
- [X] harvest on plot 302 that doesn't have a harvest date, can't find a hint for it anywhere.... May 28 found
  - https://uwprod.sharepoint.com/:x:/r/sites/SanfordLab/Shared%20Documents/Database%20development/WICST_Nutrient_Analysis/Forage/2010/2010%20440%20harvest%20information.xlsx?d=wd3d5dae5f4334481a2f9e3200663d660&csf=1&web=1&e=KrnQ3p
- 1.12 multiplier again
- 2 hay harvests and 1 green chop.
- 3 harvests (112, 302, 405), exclosures, and biomassings
- 3 harvests shown in arlington yields
  - 112 has moisture but no lbs
  - 302 and 405 have lbs, but moisture looks imputed to be .75
- 112 and 405 dates in agcal, missing the 302 date
- only 112 is in cs6 hay, date is just 1 day off
*** 2011
- uses 1.12x for first and second cuts, not 3rd to match arl yields. master doesn't use this multiplier
*** DONE 2012
- doesn't use multiplier
- 1 harvest manually added, no quadrats, 4 cuts of exclosures
*** REVISIT 2013
- [X] percent of the distributed yields
  - action: make them all null, delete the last percent moisture, add comment about nonconfidence of field sample
- 16 exclosures are in master, and they all match
- 4 harvests, only one has a grab bag sample, but originally in the data sheet they wanted to use .6. the grab sample was aroudn 78 ish
*** 2014
- 16 exclosures, all match up with master
- two baleage chops for 112, 207. percent moisture unknown
*** 2015
- 4 baleage plots as "first cut", yield values are calculated at .6 but we deleted those for missing moisture
- YIELD
  - in order for the numbers to match, we need to impute the moistures for .6
*** 2016
- plot 112 is eheee
- plot 207: heee
- plot 302: eeee (one empty "harvest") with bagging information, and comment (flail harvested)
- plot 405: heee
- mix of exclosures and harvests, all the numbers are there, just the numbering of the cuts are different and harvest
- YIELD
  - for 112, it's sum(eeee) missing one of the harvests?, but maybe reasonable
  - for 207, its sum(heee)
  - for 302, its sum(eeee)
  - for 405, its sum(heee)
*** DONE 2017
- 112: eeee
- 207: heee
- 302: eeee
- 405: heee
- may need to add moisture info "81.40456" to the 405 harvest
- YIELD
  - matches HE_GS numbers
*** 2018
- 16 exclosures, everything matches
*** 2019
- 15 exclosures, 1 harvest, everything matches
- 112: heee
- rest of plots are eeee
*** 2020
- 12 harvests, the qa sheet doesn't account for shed dimensions
- very close
*** 2021
- 15 exclosures and 1 harvest
- 112: eeee
- 207: heee
- 302: eeee
- 405: eeee
...
*** 2022
- 16 exclosures, relatively close
*** 2023
- 12 exclosures
* QA Process
...
*** DONE 1995
*** TODO 1996
- [X] urea possibly miscoded as esn?
*** TODO 1997
- [X] as required? in trt 9 and 8
  - all zero, as needed, check input in master
*** DONE 1998
*** DONE 1999
- note about 80 N being lowest setting
*** TODO 2000
- [X] pasture plots unlabeled, 40 lbs N?
*** DONE 2002
- [X] esn? was 44, but 46 in agcal?
*** DONE 2003
- [X] missing dates & range given for rate/rate_unit
*** TODO 2004
*** TODO 2005
*** DONE 2011
- needs massive review, k2so4 vs kcl is unclear, just says soil testing
** Limings QA
- [ ] change to grade not grading
** Tillings QA
*** DONE 1989
*** DONE 1990
- mechanical weeding no till cultivation not documented
*** DONE 1991
- treatment 7 had no tillage all of 1991
*** DONE 1992
- added S-tine as a comment
- treatment 6 had no tillage all of 1992, these plots primary tillage delayed until may 1993
- treatment 8 also had no tillage all of 1992
- plots 103 and 213 were accidentally disked by mistake, comment in agcal calendar noted
*** DONE 1993
- s tine as comment, treatment 6 had the delayed extra primary tillage
*** 1994
- 10, 12 treatments were untouched
- there are some cultivation no till that are not documented, highlighted in orange
*** 1995
- 10 also untouched
*** 1996
- no tills are documented in this year, but not previous years, and they're labelled as w/sweeps
*** 1997
- digger problem with and cultivator issue
- 9 untouched
*** 1998
- 10 untouched
*** 1999
- [ ] 1999 says with sweeps, 2000 agcal doesn't have it, which is it?
*** 2001
- [ ] "stalk chopper for rc biomass" ignore? added for now
- 9 untouched
*** 2002
- [ ] possible misentry for treatment 9. 2003 has w/ twisted shank, but wrong year for where it would normally be 2002. Sweeps is noted in the 2002 entry
*** 2003
- [ ] treatment 1, and treatment 4 and treatment 9, treatment 10, 13. 2003 has twisted shanks in the fall practices, and 2004 leaves it off, removing the one with less info...
*** 2004
- [X] treatment 4 has a disk entry error probably, 5-17-07 date?
- [X] treatment 4 fall practice, field digger/disk and field cultivator, they conflict if they are really different
- 8 untouched
*** 2005
- [ ] T1, twisted shank info but left off in next year. keep tw?
- [ ] T5 has a field cultivator that seems like primary? but by definition should be secondary?
- [ ] T7, twisted shank info but left off in next year. keep tw?
*** 2010
- [X] T9 has chisel in fall practice, but disk-chisel in 2011
*** 2013
- [ ] T3 has a strip till in fall practice in 2014 agcal, this is normally the place for 2014 striptills... is this just misdated?
*** 2014
- [ ] T1 disk chisel in 2015 agcal, but has chisel plow in 2014.
*** 2015
- what is Agco 4511, is that a disk chisel? yes
*** 2016
- nothing
*** 2017
- t4 has entry for 2016 under field cultivate where normally for 2017
*** 2019
- T6, Field cultivation 8/21/19 at bottom. Brillion and sunflower, is it both on that day?
- T1, T6, T10, several others with depth 2, are these actually 2 passes? 2020 has 2x in treatment 1, but 2" in 2019
*** Notes
- field digger can be primary or secondary. Fall practices should be primary, otherwise leave them as secondary.
- "no till cultivation" like a chisel plow, but with sweeps. We will call these row cultivator with "no-till with sweeps" modifier
- repairing a seedbed
- chisel plot should
- [ ] c-shank? comments that have c-shank, wondering if this should be coded as a modifier
- [ ] 4511, some just labeled chisel, should it be "disk-chisel"? for consistency?
- [ ] DW's 4-row unit, what company/equipment was this? (comments)
- [ ] 15' Balzer, how to code this correctly?
- [ ] Vertical tillage considered "secondary" in 2014, should change to primary?
- [ ] Similarly, disk-chisel is secondary in
*** Cleaning
...
- 201 <-> 214
** 2014
- labels look scrambled, values all look the same... but missing a few in the raw data. Must have been filled in otherwise
** 2015
* Actions
* Data Entry
- [X] add Pioneer P0421Q https://northfortyseed.com/wp-content/uploads/2019/02/P0421Q.pdf as corn option
- [ ] add canopeo sheet for data entry
  - [ ] decide on what biomasses to use for those canopeo entries w/ gregg
- [ ] corn silage as main data entry
- [X] add extra tilling columns
- [X] change kcl to 0-0-60, and k2so4 to 0-0-50-17
- [ ] document tillings
* Soil Archive
- sieved to 2-4 mm, and use square corepak jars
- identifiers for physical samples. What's the system of the labeling?
- cost more to wash the jars, about 50c a jar
- plot, location, depth, location in plot. SOCnet is getting archived and wicst
- aphis guidelines?
** Important Attributes
- plot, location, depth, location
