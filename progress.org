...
*** REVISIT 2002
- plot 302, unsure if there was actually a cut here, cs6_pasture sheet shows NA here
...
*** REVIEW 2008
- [ ] Missing cycle and tenday for calculations
...
- [ ] the first hay exclosure yield looks like it's just copied from green chop, remove?
...
*** REVIEW 2013
- [ ] percent of the distributed yields
